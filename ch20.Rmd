---
title: "Chapter 20 - Excersises - R for Data Science"
...
6. What happens when you subset with a positive integer thatÅfs bigger than the length of the vector? What happens when you subset with a name that doesnÅft exist?
...
2. What happens if you subset a tibble as if youÅfre subsetting a list? What are the key differences between a list and a tibble?
