Chapter 19 - Exercises - R for Data Science
================
...
Ussing a common prefix for related functions is a good idea because when
...
Example 2: `if` allows us to execute expressions which generate
